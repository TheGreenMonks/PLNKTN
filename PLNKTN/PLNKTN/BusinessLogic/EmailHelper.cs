...
namespace PLNKTN.BusinessLogic
{
    ...
    {
        private static readonly string pwFile = "C:\\gmpw.txt";
        private ICollection<string> messageLines = new List<string>();

        public void AddEmailMessageLine(string userId, string itemCompleted, string itemCompletedId)
        {
        ...
        public void SendEmail(string controllerName)
        {
