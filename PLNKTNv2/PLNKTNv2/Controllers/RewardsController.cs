...
namespace PLNKTNv2.Controllers
{
    ...
    public class RewardsController : ControllerBase
    {
        ...
        #endregion Calculate Reward Completion
        ...
        * we can check early if the user is activly tracking this category while using PLNKTNv2.
        */
        ...
        #endregion Calculate Challenge Completion
